                ...
                <div class="product_info-buttons">
                        @if (Auth::check())
                            @if (Auth::user()->is_admin == 1)
                                <a href="#" class="product_info-buttons-pay">
                                    Вы являетесь админом
                                    <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                                        <g clip-path="url(#clip015061)">
                            ...
                            @else
                                <a href="#"  class="product_info-buttons-pay" onclick="event.preventDefault(); document.getElementById('payment-form').submit();">
                                    Оплатить
                                    <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                                        <g clip-path="url(#clip015061)">
                                            <path d="M10.9853 26.1545C11.6456 26.1545 12.181 25.6271 12.181 24.9765C12.181 24.3259 11.6456 23.7985 10.9853 23.7985C10.3249 23.7985 9.78961 24.3259 9.78961 24.9765C9.78961 25.6271 10.3249 26.1545 10.9853 26.1545Z" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            @endif
                        @else
                            <a href="{{ route('auth') }}" class="product_info-buttons-pay">
                                Оплатить
                                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                                    <g clip-path="url(#clip015061)">
                                        <path d="M10.9853 26.1545C11.6456 26.1545 12.181 25.6271 12.181 24.9765C12.181 24.3259 11.6456 23.7985 10.9853 23.7985C10.3249 23.7985 9.78961 24.3259 9.78961 24.9765C9.78961 25.6271 10.3249 26.1545 10.9853 26.1545Z" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        @endif
                        <form id="payment-form" style="display: none;" action="{{ route('post_purchase', [$order->id]) }}" method="POST">
                            @csrf
                            <!-- Другие поля формы -->
                        </form>
